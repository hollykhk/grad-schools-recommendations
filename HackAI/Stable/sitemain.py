...
def submit():
    print("Submitted:")
    saspuni("uni1", flask.request.form)
    saspuni("uni2", flask.request.form)
    saspuni("uni3", flask.request.form)
    saspuni("uni4", flask.request.form)
    saspuni("uni5", flask.request.form)
    return flask.render_template("index.html")
